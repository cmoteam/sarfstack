...
- **Set**: ICPアカウント定義、Tier分類、Intent Dataシグナル、Pipeline目標を `knowledge/company/` に書く
- **Ask**: 「このICPに対するABMキャンペーン案を3層で設計して」「このLead Scoringモデルを評価して」
- **Action**: アカウントリスト作成、個別LP、アウトバウンドシーケンス、ウェビナー実施
- **Feedback**: Pipeline Coverage、Win Rate、各チャネル別ROIを `knowledge/latest/performance-data.md` に記録
