...
価格関連の数字は直接 pull したほうが精度が上がる。詳細は [`knowledge/foundation/integrations.md`](../../knowledge/foundation/integrations.md)。
...
- プラン変更履歴は `/feedback` 経由で `memory/results/` にも残す（顧客別の Discount 情報は除く）
