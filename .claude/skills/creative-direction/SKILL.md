...
接続されていればクリエイティブアセットと実配信結果を直接読む。詳細は [`knowledge/foundation/integrations.md`](../../knowledge/foundation/integrations.md)。
...
| Notion | `notion` MCP | ブランドガイドライン・ブリーフの同期 | `memory/company/brand-guidelines.md` 手動 |
